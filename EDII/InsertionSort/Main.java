      ...
      public static void main(String[] args) {
            ...
            for (int i = 0; i < tamanhoArquivo.length; i++) {
                  ...
                  try {
                        ...
                        int sortedInsetion[] = insertionSort.sort(nInteger);
                        ...
                        writer.writeDocument(sortedInsetion, nomesArquivo[i], "Insertion Sort", tempo, insertionSort.contOp,
                                    insertionSort.contMov);
